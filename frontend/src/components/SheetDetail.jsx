      ...
      <div className="bg-white rounded-lg shadow-md mb-6">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <StatCard title="Anzahl Angebote" value={currentData.anzahl ?? 0} icon="📊" />
            <StatCard title="Gesamt-Summe" value={formatCurrency(currentData.summe ?? 0)} icon="💰" highlight />
          </div>
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg shadow-md mb-6">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <StatCard title="Anzahl Angebote" value={currentData.anzahl} icon="📊" />
            <StatCard title="Gesamt-Summe" value={formatCurrency(currentData.summe)} icon="💰" highlight />
          </div>
